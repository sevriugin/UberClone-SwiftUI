    ...
    var body: some View {
        VStack(alignment: .leading) {
            Button(action: {
                ...
                Text("").frame(minWidth: 0, maxWidth: userData.showSideMenu ? 120 : 0, minHeight: 0, maxHeight: .infinity).background(Color(.sRGB, red: 0, green: 0, blue: 0, opacity: userData.showSideMenu ? 0.6 : 0)).animation(.easeInOut)
            })
